...
export class DOTDiagram extends React.Component<any, any, Props2> {
  ...
  render() {
    ...
    if (typeof this.state.chart === 'undefined') {
      ...
      return (
        <div style={this.state.messageStyle} id="dot-diagram-message">
  ...
  async componentDidUpdate(prevProps: any, prevState: any) {
    ...
    const messageDiv = document.getElementById('dot-diagram-message');
    if (messageDiv) {
  ...
  async RenderDiagram(chartContainer: any) {
    ...
    // Initialize
    // ========================================================================
    const vizworker = new viz({ worker: this.state.worker });
